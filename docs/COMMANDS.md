...
constants, replay/test status enums, non-blank required identity strings, unique
set-like arrays, non-blank file-list entries, numeric range bounds, RFC3339
timestamps, eval-summary totals, and timestamp ordering. It can also validate
